$(function(){
	 ...
	 editor.focus();//获取焦点
	 enableBasicAutocompletion = true//语法提示
	 enableLiveAutocompletion = true
	 editor.moveCursorTo(1, 0);//设置光标在第一行开始
	 editor.getSession().setMode("ace/mode/python");
	 editor.session.setMode("ace/mode/python");//设置语言
	 editor.setOptions({//代码提示
	...
	var editor = ace.edit("editor");//初始化
		...
		enableBasicAutocompletion = true//语法提示
		enableLiveAutocompletion = true
		editor.moveCursorTo(flag, 0);//设置光标在第一行开始
		editor.getSession().setMode("ace/mode/python");
		editor.session.setMode("ace/mode/python");//设置语言
		editor.setOptions({//代码提示
			enableBasicAutocompletion: true,
